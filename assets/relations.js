(function(){
 ...
 if(top&&!top.querySelector('a[href*="entries"]')){const a=document.createElement('a');a.href='../entries.html';a.textContent='分录库';top.insertBefore(a,top.lastElementChild)}
 const rel={
 21:[['第20章 · 持有待售与丧失控制','../chapter20/learn.html','先看出售子公司时为什么“是否丧失控制”会改变持有待售处理，再回来理解合并范围。'],['全站术语库','../glossary.html','搜索控制、商誉、少数股东权益、抵销分录等跨章概念。'],['全站分录库','../entries.html','把企业合并、调整与内部抵销分录放到一起对照。']],
 22:[['第23章 · 资产负债表日后事项','../chapter23/learn.html','前期差错与日后调整经常一起考：关键都是“信息究竟属于哪个期间”。'],['全站术语库','../glossary.html','对照追溯调整、未来适用、追溯重述等容易混淆的术语。'],['全站分录库','../entries.html','集中看以前年度损益调整、留存收益和所得税相关分录。']],
 23:[['第22章 · 政策、估计与差错','../chapter22/learn.html','如果日后期间发现的是以前就做错了，先回到前期差错的处理逻辑。'],['全站术语库','../glossary.html','搜索调整事项、非调整事项、以前年度损益调整等术语。'],['全站分录库','../entries.html','对照诉讼、坏账、所得税和留存收益的调整分录。']],
 24:[['第25章 · 民间非营利组织会计','../chapter25/learn.html','两章都不能直接套普通企业“股东利润”思路，适合对照资金来源、用途和净资产。'],['全站术语库','../glossary.html','搜索预算会计、资金结存、净资产等概念。'],['全站分录库','../entries.html','把财务会计与预算会计的双分录集中对照。']],
 25:[['第24章 · 政府会计','../chapter24/learn.html','对照政府会计的预算/财务双体系，更容易理解特殊主体为什么有不同的净资产和收入分类。'],['全站术语库','../glossary.html','搜索限定性净资产、受托代理、预算收入等跨章术语。'],['全站分录库','../entries.html','集中看捐赠、限定解除、受托代理和净资产结转分录。']]
 };
